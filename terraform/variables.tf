...
variable "s3_bucket_name" {
  ...
  default     = "myterraformdevops" //Substitua por seu bucket S3
}

variable "github_owner" {
  description = "Dono do repositório GitHub"
  default     = "lucasfukuta" //Substitua por seu usuario github
}

variable "github_repo" {
  description = "Nome do repositório no GitHub"
  default     = "secops-terraform" //Substitua por seu repositorio no GitHub
}
